...
function sanitizeCustomProperties(styles42) {
  const nonNullValues = Object.entries(styles42).filter(([_, value]) => value != null);
...
function useBreakpoints(options) {
  const [breakpoints2, setBreakpoints] = (0, import_react22.useState)(getMatches(options?.defaults, true));
...
function Icon({
  ...
  const contentMarkup = {
    function: /* @__PURE__ */ import_react23.default.createElement(SourceComponent, Object.assign({
    ...
    placeholder: /* @__PURE__ */ import_react23.default.createElement("div", {
      className: styles3.Placeholder
    }),
    external: /* @__PURE__ */ import_react23.default.createElement("img", {
  ...
  return /* @__PURE__ */ import_react23.default.createElement("span", {
    className
  }, accessibilityLabel && /* @__PURE__ */ import_react23.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
...
function Spinner({
  ...
  const spinnerSVGMarkup = size2 === "large" ? /* @__PURE__ */ import_react25.default.createElement("svg", {
    viewBox: "0 0 44 44",
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && /* @__PURE__ */ import_react25.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, accessibilityLabel);
  return /* @__PURE__ */ import_react25.default.createElement(import_react25.default.Fragment, null, /* @__PURE__ */ import_react25.default.createElement("span", {
    className
  }, spinnerSVGMarkup), /* @__PURE__ */ import_react25.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
var LinkContext = /* @__PURE__ */ (0, import_react27.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/link/hooks.js
function useLink() {
  return (0, import_react28.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = /* @__PURE__ */ (0, import_react29.memo)(/* @__PURE__ */ (0, import_react29.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return /* @__PURE__ */ import_react29.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props, {
      ref: _ref
    }));
  }
  const {
  ...
  return /* @__PURE__ */ import_react29.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? (
      ...
      /* @__PURE__ */ import_react30.default.createElement("a", commonProps, children)
    ) : /* @__PURE__ */ import_react30.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      target,
      download
    ...
    buttonMarkup = /* @__PURE__ */ import_react30.default.createElement("button", Object.assign({}, interactiveProps, {
...
var I18nContext = /* @__PURE__ */ (0, import_react31.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/i18n/hooks.js
function useI18n() {
  const i18n = (0, import_react32.useContext)(I18nContext);
  if (!i18n) {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? /* @__PURE__ */ import_react33.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? /* @__PURE__ */ import_react33.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? /* @__PURE__ */ import_react33.default.createElement("span", {
    className: loading ? styles2.hidden : styles2.Icon
  }, iconSource) : null;
  ...
  const childMarkup = children ? /* @__PURE__ */ import_react33.default.createElement(Text, {
    as: "span",
    variant: textVariant,
    fontWeight: textFontWeight,
    key: disabled ? "text-disabled" : "text"
  }, children) : null;
  const spinnerSVGMarkup = loading ? /* @__PURE__ */ import_react33.default.createElement("span", {
  ...
  const buttonMarkup = /* @__PURE__ */ import_react33.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup);
  return buttonMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Box/Box.js
var Box = /* @__PURE__ */ (0, import_react34.forwardRef)(({
  as = "div",
  background,
  borderColor,
  borderStyle,
  ...
  return /* @__PURE__ */ import_react34.default.createElement(as, {
    className,
    id,
    ref,
...
var WithinContentContext = /* @__PURE__ */ (0, import_react35.createContext)(false);
...
function ShadowBevel(props) {
  ...
  const Component2 = as;
  return /* @__PURE__ */ import_react36.default.createElement(Component2, {
...
var WithinFilterContext = /* @__PURE__ */ (0, import_react40.createContext)(false);
...
var progressIconMap = {
  complete: () => /* @__PURE__ */ import_react42.default.createElement("svg", {
    viewBox: "0 0 20 20"
  ...
  partiallyComplete: () => /* @__PURE__ */ import_react42.default.createElement("svg", {
    viewBox: "0 0 20 20"
  }, /* @__PURE__ */ import_react42.default.createElement("path", {
    fillRule: "evenodd",
  ...
  incomplete: () => /* @__PURE__ */ import_react42.default.createElement("svg", {
    viewBox: "0 0 20 20"
  }, /* @__PURE__ */ import_react42.default.createElement("path", {
    fillRule: "evenodd",
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react42.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && /* @__PURE__ */ import_react42.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = /* @__PURE__ */ import_react42.default.createElement("span", {
  ...
  return /* @__PURE__ */ import_react42.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && /* @__PURE__ */ import_react42.default.createElement("span", {
    className: styles9.Icon
  }, /* @__PURE__ */ import_react42.default.createElement(Icon, {
    source: icon
  })), children && /* @__PURE__ */ import_react42.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
...
var BannerContext = /* @__PURE__ */ (0, import_react43.createContext)(false);
...
function useEventListener(eventName, handler, target, options) {
  const handlerRef = (0, import_react44.useRef)(handler);
...
function useBannerFocus(bannerRef) {
  ...
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react45.useState)(false);
  (0, import_react45.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function wrapWithComponent(element, Component2, props) {
  ...
  return isElementOfType(element, Component2) ? element : /* @__PURE__ */ import_react46.default.createElement(Component2, props, element);
}
...
function isElementOfType(element, Component2) {
  if (element == null || !/* @__PURE__ */ (0, import_react46.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children, predicate = () => true) {
  return import_react46.Children.toArray(children).filter((child) => /* @__PURE__ */ (0, import_react46.isValidElement)(child) && predicate(child));
}
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react47.useState)(initialState);
  return {
    value,
    toggle: (0, import_react47.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react47.useCallback)(() => setState(true), []),
    setFalse: (0, import_react47.useCallback)(() => setState(false), [])
  };
}
...
function Item({
  ...
  const className = classNames(styles12.Item, focused && styles12["Item-focused"], button.props.variant === "plain" && styles12["Item-plain"]);
...
function ButtonGroup({
  ...
  const className = classNames(styles12.ButtonGroup, gap && styles12[gap], variant && styles12[variationName("variant", variant)], fullWidth && styles12.fullWidth, noWrap && styles12.noWrap);
  const contents = elementChildren(children).map((child, index) => /* @__PURE__ */ import_react49.default.createElement(Item, {
    button: child,
    key: index
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = /* @__PURE__ */ (0, import_react50.forwardRef)(function Banner2(props, bannerRef) {
  const {
    tone,
    stopAnnouncements
  } = props;
  const withinContentContainer = (0, import_react50.useContext)(WithinContentContext);
  const {
    wrapperRef,
    handleKeyUp,
    handleBlur,
  ...
  const className = classNames(styles11.Banner, shouldShowFocus && styles11.keyFocused, withinContentContainer ? styles11.withinContentContainer : styles11.withinPage);
  return /* @__PURE__ */ import_react50.default.createElement(BannerContext.Provider, {
    value: true
    ...
    onKeyUp: handleKeyUp,
    onBlur: handleBlur
  }, /* @__PURE__ */ import_react50.default.createElement(BannerLayout, props)));
});
function BannerLayout({
  ...
  const sharedBannerProps = {
    ...
    bannerTitle: title ? /* @__PURE__ */ import_react50.default.createElement(Text, {
      as: "h2",
      variant: "headingSm",
      breakWord: true
    }, title) : null,
    bannerIcon: hideIcon ? null : /* @__PURE__ */ import_react50.default.createElement("span", {
      className: styles11[bannerColors.icon]
    }, /* @__PURE__ */ import_react50.default.createElement(Icon, {
      source: icon ?? bannerAttributes[bannerTone].icon
    })),
    actionButtons: action || secondaryAction ? /* @__PURE__ */ import_react50.default.createElement(ButtonGroup, null, action && /* @__PURE__ */ import_react50.default.createElement(Button, Object.assign({
      onClick: action.onAction
    }, action), action.content), secondaryAction && /* @__PURE__ */ import_react50.default.createElement(Button, Object.assign({
      onClick: secondaryAction.onAction
    }, secondaryAction), secondaryAction.content)) : null,
    dismissButton: onDismiss ? /* @__PURE__ */ import_react50.default.createElement(Button, {
      variant: "tertiary",
      icon: /* @__PURE__ */ import_react50.default.createElement("span", {
        className: styles11[isInlineIconBanner ? "icon-secondary" : bannerColors.icon]
      }, /* @__PURE__ */ import_react50.default.createElement(Icon, {
        source: SvgXIcon
      })),
      onClick: onDismiss,
  ...
  const childrenMarkup = children ? /* @__PURE__ */ import_react50.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, children) : null;
  if (withinContentContainer) {
    return /* @__PURE__ */ import_react50.default.createElement(WithinContentContainerBanner, sharedBannerProps, childrenMarkup);
  }
  if (isInlineIconBanner) {
    return /* @__PURE__ */ import_react50.default.createElement(InlineIconBanner, sharedBannerProps, childrenMarkup);
  }
  return /* @__PURE__ */ import_react50.default.createElement(DefaultBanner, sharedBannerProps, childrenMarkup);
}
function DefaultBanner({
  ...
  return /* @__PURE__ */ import_react50.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react50.default.createElement(BlockStack, {
    align: "space-between"
    ...
    padding: "300"
  }, /* @__PURE__ */ import_react50.default.createElement(InlineStack, {
    align: "space-between",
    blockAlign: "center",
    gap: "200",
    wrap: false
    ...
    gap: "100",
    wrap: false
  }, bannerIcon, bannerTitle), dismissButton)), hasContent && /* @__PURE__ */ import_react50.default.createElement(Box, {
    padding: {
      xs: "300",
      md: "400"
    },
    ...
    gap: "200"
  }, /* @__PURE__ */ import_react50.default.createElement("div", null, children), actionButtons))));
}
function InlineIconBanner({
  ...
  const [blockAlign, setBlockAlign] = (0, import_react50.useState)("center");
  const contentNode = (0, import_react50.useRef)(null);
  const iconNode = (0, import_react50.useRef)(null);
  const dismissIconNode = (0, import_react50.useRef)(null);
  const handleResize = (0, import_react50.useCallback)(() => {
  ...
  (0, import_react50.useEffect)(() => handleResize(), [handleResize]);
  ...
  return /* @__PURE__ */ import_react50.default.createElement(Box, {
    ...
    wrap: false,
    blockAlign
  }, bannerIcon ? /* @__PURE__ */ import_react50.default.createElement("div", {
    ref: iconNode
  }, /* @__PURE__ */ import_react50.default.createElement(Box, {
    background: backgroundColor,
    borderRadius: "200",
    padding: "100"
  }, bannerIcon)) : null, /* @__PURE__ */ import_react50.default.createElement(Box, {
    ref: contentNode,
    width: "100%"
  }, /* @__PURE__ */ import_react50.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react50.default.createElement("div", null, children), actionButtons)))), /* @__PURE__ */ import_react50.default.createElement("div", {
    ref: dismissIconNode,
    className: styles11.DismissIcon
  }, dismissButton)));
}
function WithinContentContainerBanner({
  ...
  return /* @__PURE__ */ import_react50.default.createElement(Box, {
    ...
    gap: "150",
    wrap: false
  }, bannerIcon, /* @__PURE__ */ import_react50.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react50.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react50.default.createElement(BlockStack, {
    gap: "050"
  }, bannerTitle, /* @__PURE__ */ import_react50.default.createElement("div", null, children)), actionButtons))), dismissButton));
}
...
var EphemeralPresenceManagerContext = /* @__PURE__ */ (0, import_react51.createContext)(void 0);
...
var ThemeContext = /* @__PURE__ */ (0, import_react53.createContext)(null);
var ThemeNameContext = /* @__PURE__ */ (0, import_react53.createContext)(null);
...
function useThemeName() {
  const themeName = (0, import_react53.useContext)(ThemeNameContext);
  if (!themeName) {
...
var PortalsManagerContext = /* @__PURE__ */ (0, import_react54.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/portals/hooks.js
function usePortalsManager() {
  const portalsManager = (0, import_react55.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function ThemeProvider(props) {
  ...
  return /* @__PURE__ */ import_react56.default.createElement(ThemeNameContext.Provider, {
    value: themeName
  }, /* @__PURE__ */ import_react56.default.createElement(ThemeContext.Provider, {
    value: getTheme(themeName)
  }, /* @__PURE__ */ import_react56.default.createElement(ThemeContainer, {
    "data-portal-id": props["data-portal-id"],
    className: classNames(createThemeClassName(themeName), styles15.themeContainer, className)
  }, children)));
}
...
var StickyManagerContext = /* @__PURE__ */ (0, import_react62.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/components/Scrollable/Scrollable.js
var MAX_SCROLL_HINT_DISTANCE = 100;
var LOW_RES_BUFFER = 2;
var ScrollableComponent = /* @__PURE__ */ (0, import_react63.forwardRef)(({
  children,
  className,
  horizontal = true,
  vertical = true,
  ...
  const [topShadow, setTopShadow] = (0, import_react63.useState)(false);
  const [bottomShadow, setBottomShadow] = (0, import_react63.useState)(false);
  const stickyManager = useLazyRef(() => new StickyManager());
  const scrollArea = (0, import_react63.useRef)(null);
  const scrollTo = (0, import_react63.useCallback)((scrollY, options = {}) => {
  ...
  const defaultRef = (0, import_react63.useRef)();
  (0, import_react63.useImperativeHandle)(forwardedRef || defaultRef, () => ({
    scrollTo
  }));
  const handleScroll = (0, import_react63.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react63.default.createElement(ScrollableContext.Provider, {
    value: scrollTo
  }, /* @__PURE__ */ import_react63.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager.current
  }, /* @__PURE__ */ import_react63.default.createElement("div", Object.assign({
...
var EventListener = class extends import_react64.PureComponent {
  componentDidMount() {
    this.attachListener();
  }
  componentDidUpdate({
...
var PositionedOverlay = class extends import_react65.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react65.default.createElement("div", {
      ...
      style,
      ref: this.setOverlay
    }, /* @__PURE__ */ import_react65.default.createElement(EventListener, {
      event: "resize",
...
// node_modules/@shopify/polaris/build/esm/components/Tooltip/components/TooltipOverlay/TooltipOverlay.js
var tailUpPaths = /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, /* @__PURE__ */ import_react66.default.createElement("path", {
...
var tailDownPaths = /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, /* @__PURE__ */ import_react66.default.createElement("path", {
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? /* @__PURE__ */ import_react66.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return /* @__PURE__ */ import_react66.default.createElement("div", Object.assign({
      style,
      className: containerClassName
    }, layer.props), /* @__PURE__ */ import_react66.default.createElement("svg", {
      className: styles16.Tail,
      width: "19",
      height: "11",
      fill: "none"
    }, positioning === "above" ? tailDownPaths : tailUpPaths), /* @__PURE__ */ import_react66.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react67.useState)(null);
  const {
    presenceList,
    addPresence,
    removePresence
  ...
  const activatorContainer = (0, import_react67.useRef)(null);
  const mouseEntered = (0, import_react67.useRef)(false);
  const [shouldAnimate, setShouldAnimate] = (0, import_react67.useState)(Boolean(!originalActive));
  const hoverDelayTimeout = (0, import_react67.useRef)(null);
  const hoverOutTimeout = (0, import_react67.useRef)(null);
  ...
  const handleOpen = (0, import_react67.useCallback)(() => {
  ...
  const handleKeyUp = (0, import_react67.useCallback)((event) => {
    if (event.key !== "Escape")
      return;
    handleClose?.();
    handleBlur();
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react67.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, /* @__PURE__ */ import_react67.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
  ...
  return /* @__PURE__ */ import_react67.default.createElement(WrapperComponent, {
    onFocus: () => {
      handleOpen();
      handleFocus();
    },
...
function Cell({
  ...
  const className = classNames(styles13.Cell, styles13[`Cell-${variationName("verticalAlign", verticalAlign)}`], firstColumn && styles13["Cell-firstColumn"], truncate && styles13["Cell-truncated"], header && styles13["Cell-header"], total && styles13["Cell-total"], totalInFooter && styles13["Cell-total-footer"], numeric && styles13["Cell-numeric"], sortable && styles13["Cell-sortable"], sorted && styles13["Cell-sorted"], stickyHeadingCell && styles13.StickyHeaderCell, hovered && styles13["Cell-hovered"], lastFixedFirstColumn && inFixedNthColumn && fixedCellVisible && styles13["Cell-separate"], nthColumn && inFixedNthColumn && stickyHeadingCell && styles13.FixedFirstColumn);
  const headerClassName = classNames(header && styles13.Heading, header && contentType === "text" && styles13["Heading-left"]);
  const iconClassName = classNames(sortable && styles13.Icon);
  ...
  const iconMarkup = /* @__PURE__ */ import_react68.default.createElement("span", {
  ...
  const sortableHeadingContent = /* @__PURE__ */ import_react68.default.createElement("button", {
  ...
  const stickyHeading = /* @__PURE__ */ import_react68.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? /* @__PURE__ */ import_react68.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : /* @__PURE__ */ import_react68.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? /* @__PURE__ */ import_react68.default.createElement(TruncatedText, {
    className: styles13.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : /* @__PURE__ */ import_react68.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react68.useRef)(null);
  const {
    current
  } = textRef;
  const text2 = /* @__PURE__ */ import_react68.default.createElement("span", {
    ref: textRef,
    className
  }, children);
  return current?.scrollWidth > current?.offsetWidth ? /* @__PURE__ */ import_react68.default.createElement(Tooltip, {
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = /* @__PURE__ */ (0, import_react70.createRef)();
  ...
  const prev = /* @__PURE__ */ import_react70.default.createElement(Button, {
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? /* @__PURE__ */ import_react70.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip,
    preferredPosition: "below"
  }, prev) : prev;
  const next = /* @__PURE__ */ import_react70.default.createElement(Button, {
  ...
  const constructedNext = nextTooltip && hasNext ? /* @__PURE__ */ import_react70.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip,
    preferredPosition: "below"
  }, next) : next;
  const previousHandler = onPrevious || noop4;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => /* @__PURE__ */ import_react70.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop4;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => /* @__PURE__ */ import_react70.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  if (type === "table") {
    const labelMarkup2 = label ? /* @__PURE__ */ import_react70.default.createElement(Box, {
      padding: "300",
      paddingBlockStart: "0",
      paddingBlockEnd: "0"
    ...
    return /* @__PURE__ */ import_react70.default.createElement("nav", {
      "aria-label": navLabel,
      ref: node,
      className: classNames(styles19.Pagination, styles19.table)
    }, previousButtonEvents, nextButtonEvents, /* @__PURE__ */ import_react70.default.createElement(Box, {
      ...
      className: styles19.TablePaginationActions,
      "data-buttongroup-variant": "segmented"
    }, /* @__PURE__ */ import_react70.default.createElement("div", null, constructedPrevious), labelMarkup2, /* @__PURE__ */ import_react70.default.createElement("div", null, constructedNext)))));
  }
  const labelTextMarkup = hasNext && hasPrevious ? /* @__PURE__ */ import_react70.default.createElement("span", null, label) : /* @__PURE__ */ import_react70.default.createElement(Text, {
    tone: "subdued",
    as: "span"
  }, label);
  const labelMarkup = label ? /* @__PURE__ */ import_react70.default.createElement(Box, {
    padding: "300",
    paddingBlockStart: "0",
    paddingBlockEnd: "0"
  }, /* @__PURE__ */ import_react70.default.createElement("div", {
  ...
  return /* @__PURE__ */ import_react70.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node,
    className: styles19.Pagination
  }, previousButtonEvents, nextButtonEvents, /* @__PURE__ */ import_react70.default.createElement(ButtonGroup, {
    variant: "segmented"
...
function AfterInitialMount({
  ...
  return /* @__PURE__ */ import_react71.default.createElement(import_react71.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react72.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react73.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react73.default.createElement("div", null, /* @__PURE__ */ import_react73.default.createElement("div", {
...
function Sticky(props) {
  ...
  return /* @__PURE__ */ import_react73.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  const pipMarkup = columnVisibilityData.map((column, index) => {
    if (index < fixedFirstColumns)
      return;
    const className = classNames(styles13.Pip, column.isVisible && styles13["Pip-visible"]);
  ...
  }), pipMarkup, /* @__PURE__ */ import_react74.default.createElement(Button, {
    variant: "tertiary",
    icon: SvgChevronRightIcon,
...
var DataTableInner = class extends import_react75.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = /* @__PURE__ */ (0, import_react75.createRef)();
    this.scrollContainer = /* @__PURE__ */ (0, import_react75.createRef)();
    this.table = /* @__PURE__ */ (0, import_react75.createRef)();
    this.stickyTable = /* @__PURE__ */ (0, import_react75.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        return [/* @__PURE__ */ import_react75.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), /* @__PURE__ */ import_react75.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return /* @__PURE__ */ import_react75.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      const fixedFirstColumns = this.fixedFirstColumns();
      const className = classNames(styles13.TableRow, hoverable && styles13.hoverable);
      return /* @__PURE__ */ import_react75.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const className = classNames(styles13.DataTable, condensed && styles13.condensed, totals && styles13.ShowTotals, showTotalsInFooter && styles13.ShowTotalsInFooter, hasZebraStripingOnData && styles13.ZebraStripingOnData, hasZebraStripingOnData && rowCountIsEven && styles13.RowCountIsEven);
    const wrapperClassName = classNames(styles13.TableWrapper, condensed && styles13.condensed, increasedTableDensity && styles13.IncreasedTableDensity, stickyHeader && styles13.StickyHeaderEnabled);
    const headingMarkup = /* @__PURE__ */ import_react75.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? /* @__PURE__ */ import_react75.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && /* @__PURE__ */ import_react75.default.createElement("table", {
      className: classNames(styles13.FixedFirstColumn, !isScrolledFarthestLeft && styles13.separate),
      style: {
        width: `${columnVisibilityData[fixedFirstColumns - 1]?.rightEdge}px`
      }
    }, /* @__PURE__ */ import_react75.default.createElement("thead", null, /* @__PURE__ */ import_react75.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && /* @__PURE__ */ import_react75.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), /* @__PURE__ */ import_react75.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && /* @__PURE__ */ import_react75.default.createElement("tfoot", null, /* @__PURE__ */ import_react75.default.createElement("tr", null, nthTotals?.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? /* @__PURE__ */ import_react75.default.createElement("div", {
      className: styles13.Footer
    }, footerContent) : null;
    const paginationMarkup = pagination ? /* @__PURE__ */ import_react75.default.createElement(Pagination, Object.assign({
      type: "table"
    }, pagination)) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? /* @__PURE__ */ import_react75.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : /* @__PURE__ */ import_react75.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? /* @__PURE__ */ import_react75.default.createElement(AfterInitialMount, null, /* @__PURE__ */ import_react75.default.createElement("div", {
      className: styles13.StickyHeaderWrapper,
      role: "presentation"
    }, /* @__PURE__ */ import_react75.default.createElement(Sticky, {
      ...
      const stickyHeaderInnerClassNames = classNames(styles13.StickyHeaderInner, isSticky && styles13["StickyHeaderInner-isSticky"]);
      const stickyHeaderTableClassNames = classNames(styles13.StickyHeaderTable, !isScrolledFarthestLeft && styles13.separate);
      return /* @__PURE__ */ import_react75.default.createElement("div", {
        className: stickyHeaderInnerClassNames
      }, /* @__PURE__ */ import_react75.default.createElement("div", null, navigationMarkup("sticky")), /* @__PURE__ */ import_react75.default.createElement("table", {
        className: stickyHeaderTableClassNames,
        ref: this.stickyTable
      }, /* @__PURE__ */ import_react75.default.createElement("thead", null, /* @__PURE__ */ import_react75.default.createElement("tr", {
        className: styles13.StickyTableHeadingsRow
    ...
    return /* @__PURE__ */ import_react75.default.createElement("div", {
      ...
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), /* @__PURE__ */ import_react75.default.createElement("div", {
      className
    }, /* @__PURE__ */ import_react75.default.createElement("div", {
      className: styles13.ScrollContainer,
    ...
    }), fixedNthColumnMarkup, /* @__PURE__ */ import_react75.default.createElement("table", {
      className: styles13.Table,
      ref: this.table
    }, /* @__PURE__ */ import_react75.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), /* @__PURE__ */ import_react75.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), paginationMarkup, footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return /* @__PURE__ */ import_react75.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = /* @__PURE__ */ (0, import_react76.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react77.useContext)(DropZoneContext);
  ...
  const actionMarkup = /* @__PURE__ */ import_react77.default.createElement(Button, {
    disabled
  }, actionTitle);
  const fileUploadClassName = classNames(styles21.FileUpload, measuring && styles21.measuring, size2 === "large" && styles21.large, size2 === "small" && styles21.small);
  const actionHintMarkup = actionHint && /* @__PURE__ */ import_react77.default.createElement(Text, {
    variant: "bodySm",
    as: "p",
    tone: "subdued"
  }, actionHint);
  ...
  switch (size2) {
    case "large":
    case "medium":
      viewMarkup = /* @__PURE__ */ import_react77.default.createElement(BlockStack, {
        inlineAlign: "center",
        gap: "200"
      }, actionMarkup, actionHintMarkup);
      break;
    case "small":
      viewMarkup = /* @__PURE__ */ import_react77.default.createElement("div", {
        className: classNames(styles21.UploadIcon, disabled && styles21.disabled)
...
function InlineError({
  ...
  return /* @__PURE__ */ import_react78.default.createElement("div", {
    ...
    className: styles23.InlineError
...
function Label({
  ...
  const className = classNames(styles24.Label, hidden && styles24.hidden);
  return /* @__PURE__ */ import_react79.default.createElement("div", {
    className
  }, /* @__PURE__ */ import_react79.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
    className: classNames(styles24.Text, requiredIndicator && styles24.RequiredIndicator)
...
function buttonFrom({
  ...
  return /* @__PURE__ */ import_react80.default.createElement(Button, Object.assign({
    key,
    onClick: onAction,
    tone,
...
function Labelled({
  ...
  const className = classNames(labelHidden && styles22.hidden, disabled && styles22.disabled, readOnly && styles22.readOnly);
  const actionMarkup = action ? /* @__PURE__ */ import_react81.default.createElement("div", {
    className: styles22.Action
  }, buttonFrom(action, {
    variant: "plain"
  })) : null;
  const helpTextMarkup = helpText ? /* @__PURE__ */ import_react81.default.createElement("div", {
  ...
  const errorMarkup = error && typeof error !== "boolean" && /* @__PURE__ */ import_react81.default.createElement("div", {
    className: styles22.Error
  }, /* @__PURE__ */ import_react81.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? /* @__PURE__ */ import_react81.default.createElement("div", {
    className: styles22.LabelWrapper
  }, /* @__PURE__ */ import_react81.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
var DropZone = function DropZone2({
  ...
  const dragTargets = (0, import_react82.useRef)([]);
  const adjustSize = (0, import_react82.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react82.useState)(false);
  const [internalError, setInternalError] = (0, import_react82.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size2, setSize] = (0, import_react82.useState)("large");
  const [measuring, setMeasuring] = (0, import_react82.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react82.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react82.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react82.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react82.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react82.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const classes = classNames(styles20.DropZone, outline && styles20.hasOutline, !outline && styles20.noOutline, focused && styles20.focused, (active || dragging) && styles20.isDragging, disabled && styles20.isDisabled, (internalError || error) && styles20.hasError, !variableHeight && styles20[variationName("size", size2)], measuring && styles20.measuring);
  ...
  const open = (0, import_react82.useCallback)(() => {
    if (!inputRef.current)
      return;
    inputRef.current.click();
  }, [inputRef]);
  const triggerFileDialog = (0, import_react82.useCallback)(() => {
    open();
    onFileDialogClose?.();
  }, [open, onFileDialogClose]);
  function overlayMarkup(icon, text2, color2) {
    return /* @__PURE__ */ import_react82.default.createElement("div", {
      className: styles20.Overlay
    }, /* @__PURE__ */ import_react82.default.createElement(BlockStack, {
      gap: "200",
      inlineAlign: "center"
    }, size2 === "small" && /* @__PURE__ */ import_react82.default.createElement(Icon, {
      source: icon,
      tone: color2
    }), (size2 === "medium" || size2 === "large") && /* @__PURE__ */ import_react82.default.createElement(Text, {
      variant: "bodySm",
      as: "p",
      fontWeight: "bold"
    }, text2)));
  ...
  return /* @__PURE__ */ import_react82.default.createElement(DropZoneContext.Provider, {
    value: context
  }, /* @__PURE__ */ import_react82.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, /* @__PURE__ */ import_react82.default.createElement(Text, {
    variant: "bodySm",
    as: "span",
    visuallyHidden: true
  }, /* @__PURE__ */ import_react82.default.createElement("input", {
    id,
    accept,
    disabled,
...
function TextContainer({
  ...
  const className = classNames(styles26.TextContainer, spacing && styles26[variationName("spacing", spacing)]);
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? /* @__PURE__ */ import_react84.default.createElement(Text, {
    as: "p",
    variant: "bodyMd"
  }, description) : description;
  return /* @__PURE__ */ import_react84.default.createElement("div", {
    className: styles25.AnnotatedSection
  }, /* @__PURE__ */ import_react84.default.createElement("div", {
    className: styles25.AnnotationWrapper
  }, /* @__PURE__ */ import_react84.default.createElement("div", {
    className: styles25.Annotation
  }, /* @__PURE__ */ import_react84.default.createElement(TextContainer, {
    spacing: "tight"
  }, /* @__PURE__ */ import_react84.default.createElement(Text, {
    id,
    variant: "headingMd",
    as: "h2"
  }, title), descriptionMarkup && /* @__PURE__ */ import_react84.default.createElement(Box, {
    color: "text-secondary"
  }, descriptionMarkup))), /* @__PURE__ */ import_react84.default.createElement("div", {
    className: styles25.AnnotationContent
  }, children)));
}
...
function Section({
  ...
  const className = classNames(styles25.Section, styles25[`Section-${variant}`]);
...
var Layout = function Layout2({
  ...
  const content = sectioned ? /* @__PURE__ */ import_react86.default.createElement(Section, null, children) : children;
  return /* @__PURE__ */ import_react86.default.createElement("div", {
    className: styles25.Layout
  }, content);
};
...
function isInterface(x) {
  return !/* @__PURE__ */ (0, import_react87.isValidElement)(x) && x !== void 0;
}

// node_modules/@shopify/polaris/build/esm/utilities/is-react-element.js
var import_react88 = __toESM(require_react());
function isReactElement(x) {
  return /* @__PURE__ */ (0, import_react88.isValidElement)(x) && x !== void 0;
}
...
function Breadcrumbs({
  ...
  return /* @__PURE__ */ import_react89.default.createElement(Button, {
    key: content,
...
function Title({
  ...
  const className = classNames(styles29.Title, subtitle && styles29.TitleWithSubtitle);
  const titleMarkup = title ? /* @__PURE__ */ import_react91.default.createElement("h1", {
    className
  ...
  const titleMetadataMarkup = titleMetadata ? /* @__PURE__ */ import_react91.default.createElement(Bleed, {
    marginBlock: "100"
  }, titleMetadata) : null;
  const wrappedTitleMarkup = /* @__PURE__ */ import_react91.default.createElement("div", {
    className: styles29.TitleWrapper
  }, titleMarkup, titleMetadataMarkup);
  const subtitleMarkup = subtitle ? /* @__PURE__ */ import_react91.default.createElement("div", {
    className: classNames(styles29.SubTitle, compactTitle && styles29.SubtitleCompact, hasSubtitleMaxWidth && styles29.SubtitleMaxWidth)
  }, /* @__PURE__ */ import_react91.default.createElement(Text, {
    as: "p",
    variant: "bodySm",
    tone: "subdued"
  }, subtitle)) : null;
  return /* @__PURE__ */ import_react91.default.createElement(import_react91.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Pane({
  ...
  const className = classNames(styles33.Pane, fixed && styles33["Pane-fixed"], subdued && styles33["Pane-subdued"], captureOverscroll && styles33["Pane-captureOverscroll"]);
  ...
  return fixed ? /* @__PURE__ */ import_react93.default.createElement("div", {
    style,
    className
  }, content) : /* @__PURE__ */ import_react93.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom,
...
var PopoverOverlay = class extends import_react94.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = /* @__PURE__ */ (0, import_react94.createRef)();
    this.renderPopover = (overlayDetails) => {
      ...
      const className = classNames(styles33.Popover, measuring && styles33.measuring, (fullWidth || isCovering) && styles33.fullWidth, hideOnPrint && styles33["PopoverOverlay-hideOnPrint"], positioning && styles33[variationName("positioned", positioning)]);
      const contentStyles = measuring ? void 0 : {
        height: desiredHeight
      };
      const contentClassNames = classNames(styles33.Content, fullHeight && styles33["Content-fullHeight"], fluidContent && styles33["Content-fluidContent"]);
      return /* @__PURE__ */ import_react94.default.createElement("div", Object.assign({
        className
      }, overlay.props), /* @__PURE__ */ import_react94.default.createElement(EventListener, {
        event: "click",
        ...
        className: styles33.FocusTracker,
        tabIndex: 0,
        onFocus: this.handleFocusFirstItem
      }), /* @__PURE__ */ import_react94.default.createElement("div", {
        className: styles33.ContentContainer
      }, /* @__PURE__ */ import_react94.default.createElement("div", {
        id,
    ...
    this.overlayRef = /* @__PURE__ */ (0, import_react94.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    if (transitionStatus === TransitionStatus.Exited && !active)
      return null;
    const className = classNames(styles33.PopoverOverlay, transitionStatus === TransitionStatus.Entering && styles33["PopoverOverlay-entering"], transitionStatus === TransitionStatus.Entered && styles33["PopoverOverlay-open"], transitionStatus === TransitionStatus.Exiting && styles33["PopoverOverlay-exiting"], preferredPosition === "cover" && styles33["PopoverOverlay-noAnimation"]);
    return /* @__PURE__ */ import_react94.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = /* @__PURE__ */ (0, import_react95.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react95.useState)();
  const overlayRef = (0, import_react95.useRef)(null);
  const activatorContainer = (0, import_react95.useRef)(null);
  const WrapperComponent = activatorWrapper;
  ...
  const setAccessibilityAttributes = (0, import_react95.useCallback)(() => {
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react95.default.createElement(Portal, {
    idPrefix: "popover"
  }, /* @__PURE__ */ import_react95.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
    activator: activatorNode,
    preferInputActivator,
  ...
  return /* @__PURE__ */ import_react95.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react95.Children.only(activator), portal2);
});
...
var FilterActionsContext = /* @__PURE__ */ (0, import_react96.createContext)(false);
function FilterActionsProvider({
  children,
  filterActions
}) {
  return /* @__PURE__ */ import_react96.default.createElement(FilterActionsContext.Provider, {
    value: filterActions
  }, children);
}
...
function Item2({
  ...
  const className = classNames(styles34.Item, disabled && styles34.disabled, destructive && styles34.destructive, active && styles34.active, variant === "default" && styles34.default, variant === "indented" && styles34.indented, variant === "menu" && styles34.menu);
  let prefixMarkup = null;
  if (prefix) {
    prefixMarkup = /* @__PURE__ */ import_react97.default.createElement("span", {
  ...
  if (truncate && content) {
    contentText = /* @__PURE__ */ import_react97.default.createElement(TruncateText, null, content);
  } else if (ellipsis) {
    contentText = `${content}\u2026`;
  }
  const contentMarkup = helpText ? /* @__PURE__ */ import_react97.default.createElement(import_react97.default.Fragment, null, /* @__PURE__ */ import_react97.default.createElement(Box, null, contentText), /* @__PURE__ */ import_react97.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    tone: active || disabled ? void 0 : "subdued"
  }, helpText)) : /* @__PURE__ */ import_react97.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    fontWeight: active ? "semibold" : "regular"
  }, contentText);
  const badgeMarkup = badge && /* @__PURE__ */ import_react97.default.createElement("span", {
    className: styles34.Suffix
  }, /* @__PURE__ */ import_react97.default.createElement(Badge, {
    tone: badge.tone
  }, badge.content));
  const suffixMarkup = suffix && /* @__PURE__ */ import_react97.default.createElement(Box, null, /* @__PURE__ */ import_react97.default.createElement("span", {
    className: styles34.Suffix
  }, suffix));
  const textMarkup = /* @__PURE__ */ import_react97.default.createElement("span", {
    className: styles34.Text
  }, /* @__PURE__ */ import_react97.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    fontWeight: active ? "semibold" : "regular"
  }, contentMarkup));
  const contentElement = /* @__PURE__ */ import_react97.default.createElement(InlineStack, {
    blockAlign: "center",
    gap: "150",
    wrap: false
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const contentWrapper = /* @__PURE__ */ import_react97.default.createElement(Box, {
    width: "100%"
  }, contentElement);
  const scrollMarkup = active ? /* @__PURE__ */ import_react97.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? /* @__PURE__ */ import_react97.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentWrapper) : /* @__PURE__ */ import_react97.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return /* @__PURE__ */ import_react97.default.createElement(import_react97.default.Fragment, null, scrollMarkup, control);
}
var TruncateText = ({
  children
}) => {
  const theme = useTheme();
  const textRef = (0, import_react97.useRef)(null);
  const [isOverflowing, setIsOverflowing] = (0, import_react97.useState)(false);
  useIsomorphicLayoutEffect(() => {
    if (textRef.current) {
      setIsOverflowing(textRef.current.scrollWidth > textRef.current.offsetWidth);
    }
  }, [children]);
  const text2 = /* @__PURE__ */ import_react97.default.createElement(Text, {
    as: "span",
    truncate: true
  ...
  return isOverflowing ? /* @__PURE__ */ import_react97.default.createElement(Tooltip, {
...
function Section3({
  ...
  const actionMarkup = section.items.map(({
    ...
    const itemMarkup = /* @__PURE__ */ import_react98.default.createElement(Item2, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  if (section.title) {
    titleMarkup = typeof section.title === "string" ? /* @__PURE__ */ import_react98.default.createElement(Box, {
      paddingBlockStart: "300",
      paddingBlockEnd: "100",
      paddingInlineStart: "300",
      paddingInlineEnd: "300"
      ...
      as: "p",
      variant: "headingSm"
    }, section.title)) : /* @__PURE__ */ import_react98.default.createElement(Box, {
      padding: "200",
  ...
  const sectionMarkup = /* @__PURE__ */ import_react98.default.createElement(import_react98.default.Fragment, null, titleMarkup, /* @__PURE__ */ import_react98.default.createElement(Box, Object.assign({
    as: "div",
    padding: "150"
  }, hasMultipleSections && {
    paddingBlockStart: "0"
  ...
  }), /* @__PURE__ */ import_react98.default.createElement(BlockStack, Object.assign({
    gap: "050",
    as: "ul"
  }, sectionRole && {
    role: sectionRole
  }), actionMarkup)));
  return hasMultipleSections ? /* @__PURE__ */ import_react98.default.createElement(Box, Object.assign({
    as: "li",
    role: "presentation",
...
var Spinner2 = /* @__PURE__ */ import_react99.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp,
  ...
  return /* @__PURE__ */ import_react99.default.createElement("div", {
    className: styles35.Spinner,
    onClick,
    "aria-hidden": true,
    ref
  }, /* @__PURE__ */ import_react99.default.createElement("div", {
    role: "button",
    className: styles35.Segment,
    tabIndex: -1,
    ...
    className: styles35.SpinnerIcon
  }, /* @__PURE__ */ import_react99.default.createElement(Icon, {
...
function Item3({
  ...
  const className = classNames(styles36.Item, focused && styles36["Item-focused"], position === "primary" ? styles36["Item-primary"] : styles36["Item-connection"]);
...
function Connected({
  ...
  const leftConnectionMarkup = left ? /* @__PURE__ */ import_react101.default.createElement(Item3, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? /* @__PURE__ */ import_react101.default.createElement(Item3, {
    position: "right"
  }, right) : null;
  return /* @__PURE__ */ import_react101.default.createElement("div", {
    className: styles36.Connected
  }, leftConnectionMarkup, /* @__PURE__ */ import_react101.default.createElement(Item3, {
    position: "primary"
...
function Resizer({
  ...
  const minimumLinesMarkup = minimumLines ? /* @__PURE__ */ import_react102.default.createElement("div", {
    ref: minimumLinesNode,
    className: styles35.DummyInput,
  ...
  return /* @__PURE__ */ import_react102.default.createElement("div", {
    "aria-hidden": true,
    className: styles35.Resizer
  }, /* @__PURE__ */ import_react102.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const id = idProp ?? uniqId;
  const textFieldRef = (0, import_react103.useRef)(null);
  ...
  const loadingRef = (0, import_react103.useRef)(null);
  ...
  const getInputRef = (0, import_react103.useCallback)(() => {
  ...
  const className = classNames(styles35.TextField, Boolean(normalizedValue) && styles35.hasValue, disabled && styles35.disabled, readOnly && styles35.readOnly, error && styles35.error, tone && styles35[variationName("tone", tone)], multiline && styles35.multiline, focus && !disabled && styles35.focus, variant !== "inherit" && styles35[variant], size2 === "slim" && styles35.slim);
  const inputType = type === "currency" ? "text" : type;
  const isNumericType = type === "number" || type === "integer";
  const iconPrefix = /* @__PURE__ */ import_react103.default.isValidElement(prefix) && prefix.type === Icon;
  const prefixMarkup = prefix ? /* @__PURE__ */ import_react103.default.createElement("div", {
    className: classNames(styles35.Prefix, iconPrefix && styles35.PrefixIcon),
    id: `${id}-Prefix`,
    ref: prefixRef
  }, /* @__PURE__ */ import_react103.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, prefix)) : null;
  const suffixMarkup = suffix ? /* @__PURE__ */ import_react103.default.createElement("div", {
    className: styles35.Suffix,
    id: `${id}-Suffix`,
    ref: suffixRef
  }, /* @__PURE__ */ import_react103.default.createElement(Text, {
    as: "span",
  ...
  const loadingMarkup = loading ? /* @__PURE__ */ import_react103.default.createElement("div", {
    className: styles35.Loading,
    id: `${id}-Loading`,
    ref: loadingRef
  }, /* @__PURE__ */ import_react103.default.createElement(Spinner, {
    size: "small"
  })) : null;
  ...
  if (showCharacterCount) {
    ...
    const characterCountClassName = classNames(styles35.CharacterCount, multiline && styles35.AlignFieldBottom);
    const characterCountText = !maxLength ? characterCount : `${characterCount}/${maxLength}`;
    characterCountMarkup = /* @__PURE__ */ import_react103.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? /* @__PURE__ */ import_react103.default.createElement("button", {
    type: "button",
    className: styles35.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, /* @__PURE__ */ import_react103.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, i18n.translate("Polaris.Common.clear")), /* @__PURE__ */ import_react103.default.createElement(Icon, {
  ...
  const spinnerMarkup = isNumericType && step !== 0 && !disabled && !readOnly ? /* @__PURE__ */ import_react103.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const resizer = multiline && isAfterInitial ? /* @__PURE__ */ import_react103.default.createElement(Resizer, {
  ...
  const inputClassName = classNames(styles35.Input, align && styles35[variationName("Input-align", align)], suffix && styles35["Input-suffixed"], clearButton && styles35["Input-hasClearButton"], monospaced && styles35.monospaced, suggestion && styles35.suggestion, autoSize && styles35["Input-autoSize"]);
  ...
  const input = /* @__PURE__ */ (0, import_react103.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? /* @__PURE__ */ import_react103.default.createElement("div", {
    className: styles35.VerticalContent,
    id: `${id}-VerticalContent`,
    ref: verticalContentRef,
    onClick: handleClickChild
  }, verticalContent, input) : null;
  const inputMarkup = verticalContent ? inputWithVerticalContentMarkup : input;
  const backdropMarkup = /* @__PURE__ */ import_react103.default.createElement("div", {
    className: classNames(styles35.Backdrop, connectedLeft && styles35["Backdrop-connectedLeft"], connectedRight && styles35["Backdrop-connectedRight"])
  });
  const inputAndSuffixMarkup = autoSize ? /* @__PURE__ */ import_react103.default.createElement("div", {
    className: styles35.InputAndSuffixWrapper
  }, /* @__PURE__ */ import_react103.default.createElement("div", {
    className: classNames(styles35.AutoSizeWrapper, suffix && styles35.AutoSizeWrapperWithSuffix),
    "data-auto-size-value": value || placeholder
  }, inputMarkup), suffixMarkup) : /* @__PURE__ */ import_react103.default.createElement(import_react103.default.Fragment, null, inputMarkup, suffixMarkup);
  return /* @__PURE__ */ import_react103.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    disabled,
    readOnly
  }, /* @__PURE__ */ import_react103.default.createElement(Connected, {
    left: connectedLeft,
...
function ActionList({
  ...
  const i18n = useI18n();
  const filterActions = (0, import_react104.useContext)(FilterActionsContext);
  let finalSections = [];
  const actionListRef = (0, import_react104.useRef)(null);
  const [searchText, setSearchText] = (0, import_react104.useState)("");
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = filteredSections.map((section, index) => {
    return section.items.length > 0 ? /* @__PURE__ */ import_react104.default.createElement(Section3, {
  ...
  const listeners = actionRole === "menuitem" ? /* @__PURE__ */ import_react104.default.createElement(import_react104.default.Fragment, null, /* @__PURE__ */ import_react104.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), /* @__PURE__ */ import_react104.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  const totalFilteredActions = (0, import_react104.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react104.default.createElement(import_react104.default.Fragment, null, (allowFiltering || filterActions) && hasManyActions && isFilterable && /* @__PURE__ */ import_react104.default.createElement(Box, {
    padding: "200",
    paddingBlockEnd: totalFilteredActions > 0 ? "0" : "200"
  }, /* @__PURE__ */ import_react104.default.createElement(TextField, {
    clearButton: true,
    labelHidden: true,
    ...
    prefix: /* @__PURE__ */ import_react104.default.createElement(Icon, {
...
function RollupActions({
  ...
  const activatorMarkup = /* @__PURE__ */ import_react105.default.createElement("div", {
    className: styles32.RollupActivator
  ...
  return /* @__PURE__ */ import_react105.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, /* @__PURE__ */ import_react105.default.createElement(ActionList, {
    items,
    sections,
...
function SecondaryAction({
  ...
  const buttonMarkup = /* @__PURE__ */ import_react106.default.createElement(Button, Object.assign({
    onClick: onAction,
    tone: destructive ? "critical" : void 0
  }, rest), children);
  const actionMarkup = helpText ? /* @__PURE__ */ import_react106.default.createElement(Tooltip, {
    preferredPosition: "below",
    content: helpText
  }, buttonMarkup) : buttonMarkup;
  return /* @__PURE__ */ import_react106.default.createElement("div", {
    className: classNames(styles39.SecondaryAction, tone === "critical" && styles39.critical)
  }, actionMarkup);
}
...
function MenuGroup({
  ...
  const handleClose = (0, import_react107.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react107.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleClick = (0, import_react107.useCallback)(() => {
    if (onClick) {
      onClick(handleOpen);
    } else {
      handleOpen();
  ...
  const popoverActivator = /* @__PURE__ */ import_react107.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  return /* @__PURE__ */ import_react107.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, /* @__PURE__ */ import_react107.default.createElement(ActionList, {
    items: actions,
    sections,
    onActionAnyItem: handleClose
  }), details && /* @__PURE__ */ import_react107.default.createElement("div", {
...
function ActionsMeasurer({
  ...
  const i18n = useI18n();
  const containerNode = (0, import_react108.useRef)(null);
  const defaultRollupGroup = {
    title: i18n.translate("Polaris.ActionMenu.Actions.moreActions"),
    actions: []
  };
  const activator = /* @__PURE__ */ import_react108.default.createElement(SecondaryAction, {
    disclosure: true
  }, defaultRollupGroup.title);
  const handleMeasurement = (0, import_react108.useCallback)(() => {
  ...
  const groupsMarkup = groups.map((group) => {
    ...
    return /* @__PURE__ */ import_react108.default.createElement(SecondaryAction, {
      key: title,
      disclosure: true,
      icon
    }, title);
  ...
  return /* @__PURE__ */ import_react108.default.createElement("div", {
    className: styles37.ActionsLayoutMeasurer,
    ref: containerNode
...
function Actions({
  ...
  const i18n = useI18n();
  const rollupActiveRef = (0, import_react109.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react109.useState)(void 0);
  const [state, setState] = (0, import_react109.useReducer)((data, partialData) => {
    return {
      ...data,
      ...partialData
    };
  ...
  const handleMenuGroupToggle = (0, import_react109.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react109.useCallback)(() => setActiveMenuGroup(void 0), []);
  ...
  const actionsOrDefault = (0, import_react109.useMemo)(() => actions ?? [], [actions]);
  const groupsOrDefault = (0, import_react109.useMemo)(() => groups ?? [], [groups]);
  const actionsMarkup = actionsOrDefault.filter((_, index) => {
    ...
    return /* @__PURE__ */ import_react109.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest), content);
  });
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup) {
      return /* @__PURE__ */ import_react109.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const handleMeasurement = (0, import_react109.useCallback)((measurements) => {
    const {
  ...
  const actionsMeasurer = /* @__PURE__ */ import_react109.default.createElement(ActionsMeasurer, {
    actions,
    groups,
    handleMeasurement
  });
  return /* @__PURE__ */ import_react109.default.createElement("div", {
    className: styles37.ActionsLayoutOuter
  }, actionsMeasurer, /* @__PURE__ */ import_react109.default.createElement("div", {
    className: classNames(styles37.ActionsLayout, !hasMeasured && styles37["ActionsLayout--measuring"])
...
function ActionMenu({
  ...
  const actionMenuClassNames = classNames(styles31.ActionMenu, rollup && styles31.rollup);
  const rollupSections = groups.map((group) => convertGroupToSection(group));
  return /* @__PURE__ */ import_react110.default.createElement("div", {
    className: actionMenuClassNames
  }, rollup ? /* @__PURE__ */ import_react110.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : /* @__PURE__ */ import_react110.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var MediaQueryContext = /* @__PURE__ */ (0, import_react111.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/media-query/hooks.js
function useMediaQuery() {
  const mediaQuery = (0, import_react112.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function Header({
  ...
  const breadcrumbMarkup = backAction ? /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.BreadcrumbWrapper
  }, /* @__PURE__ */ import_react113.default.createElement(Box, {
    maxWidth: "100%",
    paddingInlineEnd: "100",
    printHidden: true
  }, /* @__PURE__ */ import_react113.default.createElement(Breadcrumbs, {
    backAction
  }))) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.PaginationWrapper
  }, /* @__PURE__ */ import_react113.default.createElement(Box, {
    printHidden: true
  }, /* @__PURE__ */ import_react113.default.createElement(Pagination, Object.assign({}, pagination, {
    hasPrevious: pagination.hasPrevious,
    hasNext: pagination.hasNext
  })))) : null;
  const pageTitleMarkup = /* @__PURE__ */ import_react113.default.createElement("div", {
    className: classNames(styles28.TitleWrapper, !hasActionGroupsOrSecondaryActions && styles28.TitleWrapperExpand)
  }, /* @__PURE__ */ import_react113.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle,
  ...
  const pageReadyAccessibilityLabelMarkup = labelForPageReadyAccessibilityLabel ? /* @__PURE__ */ import_react113.default.createElement("div", {
    role: "status"
  ...
  const primaryActionMarkup = primaryAction ? /* @__PURE__ */ import_react113.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = /* @__PURE__ */ import_react113.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = /* @__PURE__ */ import_react113.default.createElement(import_react113.default.Fragment, null, secondaryActions);
  }
  const navigationMarkup = breadcrumbMarkup || paginationMarkup ? /* @__PURE__ */ import_react113.default.createElement(Box, {
    printHidden: true,
    paddingBlockEnd: "100",
  ...
  const additionalMetadataMarkup = additionalMetadata ? /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.AdditionalMetaData
  }, /* @__PURE__ */ import_react113.default.createElement(Text, {
    tone: "subdued",
    as: "span",
    variant: "bodySm"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(isSingleRow && styles28.isSingleRow, navigationMarkup && styles28.hasNavigation, actionMenuMarkup && styles28.hasActionMenu, isNavigationCollapsed && styles28.mobileView, !backAction && styles28.noBreadcrumbs, title && title.length < LONG_TITLE && styles28.mediumTitle, title && title.length > LONG_TITLE && styles28.longTitle);
  const {
    slot1,
    slot2,
    slot3,
  ...
  return /* @__PURE__ */ import_react113.default.createElement(Box, {
    position: "relative",
    paddingBlockStart: {
      xs: "400",
      md: "600"
  ...
  }, pageReadyAccessibilityLabelMarkup, /* @__PURE__ */ import_react113.default.createElement("div", {
    className: headerClassNames
  }, /* @__PURE__ */ import_react113.default.createElement(FilterActionsProvider, {
    filterActions: Boolean(filterActions)
  }, /* @__PURE__ */ import_react113.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.Row
  }, slot1, slot2, /* @__PURE__ */ import_react113.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.RightAlign
  }, /* @__PURE__ */ import_react113.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children) => /* @__PURE__ */ import_react113.default.createElement("div", {
      className: styles28.Actions
    }, children)
  }, slot3, slot4))))), /* @__PURE__ */ import_react113.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? /* @__PURE__ */ import_react113.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  } else {
  ...
  return /* @__PURE__ */ import_react113.default.createElement("div", {
    className: styles28.PrimaryActionWrapper
  }, /* @__PURE__ */ import_react113.default.createElement(Box, {
    printHidden: true
  }, actionMarkup));
}
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: /* @__PURE__ */ import_react113.default.createElement(import_react113.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const pageClassName = classNames(styles27.Page, fullWidth && styles27.fullWidth, narrowWidth && styles27.narrowWidth);
  ...
  const contentClassName = classNames(!hasHeaderContent && styles27.Content);
  const headerMarkup = hasHeaderContent ? /* @__PURE__ */ import_react114.default.createElement(Header, Object.assign({
    filterActions: true
  }, rest)) : null;
  return /* @__PURE__ */ import_react114.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, /* @__PURE__ */ import_react114.default.createElement("div", {
    className: contentClassName
  }, children));
}
...
function Select({
  ...
  const uniqId = (0, import_react115.useId)();
  const id = idProp ?? uniqId;
  const labelHidden = labelInline ? true : labelHiddenProp;
  const className = classNames(styles40.Select, error && styles40.error, tone && styles40[variationName("tone", tone)], disabled && styles40.disabled);
  const handleFocus = (0, import_react115.useCallback)((event) => {
    toggleFocused();
    onFocus?.(event);
  }, [onFocus, toggleFocused]);
  const handleBlur = (0, import_react115.useCallback)((event) => {
    toggleFocused();
    onBlur?.(event);
  ...
  const inlineLabelMarkup = labelInline && /* @__PURE__ */ import_react115.default.createElement(Box, {
    paddingInlineEnd: "100"
  ...
  const prefixMarkup = selectedOption.prefix && /* @__PURE__ */ import_react115.default.createElement("div", {
    className: styles40.Prefix
  }, selectedOption.prefix);
  const contentMarkup = /* @__PURE__ */ import_react115.default.createElement("div", {
    className: styles40.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, /* @__PURE__ */ import_react115.default.createElement("span", {
    className: styles40.SelectedOption
  }, selectedOption.label), /* @__PURE__ */ import_react115.default.createElement("span", {
    className: styles40.Icon
  }, /* @__PURE__ */ import_react115.default.createElement(Icon, {
    source: SvgSelectIcon
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return /* @__PURE__ */ import_react115.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, /* @__PURE__ */ import_react115.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return /* @__PURE__ */ import_react115.default.createElement("option", Object.assign({
    key: key ?? value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return /* @__PURE__ */ import_react115.default.createElement("optgroup", {
      label: title,
      key: title
...
function Image({
  ...
  const handleLoad = (0, import_react116.useCallback)(() => {
    if (onLoad)
      onLoad();
  }, [onLoad]);
  return /* @__PURE__ */ import_react116.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Thumbnail({
  ...
  const className = classNames(styles41.Thumbnail, size2 && styles41[variationName("size", size2)], transparent && styles41.transparent);
  const content = typeof source === "string" ? /* @__PURE__ */ import_react117.default.createElement(Image, {
    alt,
    source
  ...
  return /* @__PURE__ */ import_react117.default.createElement("span", {
    className
  }, content);
}
...
//# sourceMappingURL=/build/_shared/chunk-LZ6DFBPK.js.map
